...
/* harmony import */ var _movie__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./movie */ "./src/movie/index.js");
...
protectedApiRouter.use('/movies', _movie__WEBPACK_IMPORTED_MODULE_6__["router"].routes());
...
/* harmony import */ var koa_router__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! koa-router */ "koa-router");
/* harmony import */ var koa_router__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(koa_router__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _store__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./store */ "./src/movie/store.js");
...
router.get('/:id', async ctx => {
  const userId = ctx.state.user._id;
  const movie = await _store__WEBPACK_IMPORTED_MODULE_1__["default"].findOne({
    _id: ctx.params.id
  });
  const response = ctx.response;
...
const createMovie = async (ctx, movie, response) => {
  try {
    const userId = ctx.state.user._id;
    movie.userId = userId;
    response.body = await _store__WEBPACK_IMPORTED_MODULE_1__["default"].insert(movie);
    response.status = 201; // created
